...
from project_routes import router as proj_router
...
def startup_db_client():
    app.mongodb_client = MongoClient("your-cluster-url (connection string)")
...
app.include_router(proj_router, tags=["projects"], prefix="/api/v1/projects")
